					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 372 777 999</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> toystore@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div>
					<div class="col-sm-6" >
						<div class="logo pull-left" >
                            ...
                            <img src="images/logoToys.png" width="70" height="70"></a>
						</div>
					</div>
					<div class="col-sm-6">
